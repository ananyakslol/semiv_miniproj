document.addEventListener('DOMContentLoaded', function() {
    ...
    const texture = new THREE.TextureLoader().load('../img/p-neptune.png');
    ...
    document.getElementById('rotate-left').onclick = () => neptune.rotation.y -= 0.5;
    document.getElementById('rotate-right').onclick = () => neptune.rotation.y += 0.5;
    ...
    document.getElementById('reset-view').onclick = () => { camera.position.set(0,0,2); neptune.rotation.set(0,0,0); };
