document.addEventListener('DOMContentLoaded', function() {
    ...
    const texture = new THREE.TextureLoader().load('../img/p-mars.png');
    ...
    document.getElementById('rotate-left').onclick = () => mars.rotation.y -= 0.5;
    document.getElementById('rotate-right').onclick = () => mars.rotation.y += 0.5;
    ...
    document.getElementById('reset-view').onclick = () => { camera.position.set(0,0,2); mars.rotation.set(0,0,0); };
