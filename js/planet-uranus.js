document.addEventListener('DOMContentLoaded', function() {
    ...
    const texture = new THREE.TextureLoader().load('../img/p-uranus.png');
    ...
    document.getElementById('rotate-left').onclick = () => uranus.rotation.y -= 0.5;
    document.getElementById('rotate-right').onclick = () => uranus.rotation.y += 0.5;
    ...
    document.getElementById('reset-view').onclick = () => { camera.position.set(0,0,2); uranus.rotation.set(0,0,0); };
